...
Проект демонструє створення інфраструктури на AWS з використанням Terraform з модульною архітектурою.
...
### Регіон AWS
Проект налаштований для роботи в регіоні `eu-central-1` (Франкфурт).
