...
"""
    ...
    environment {
        ...
        ECR_REPOSITORY = "lesson-9-django-app"
        IMAGE_TAG = "${BUILD_NUMBER}"
        AWS_DEFAULT_REGION = "eu-central-1"
        GIT_REPO = "https://github.com/mykola-ovchynnik/my-microservice-project.git"
        GIT_BRANCH = "lesson-4"
    }
                    ...
                    script {
                        withCredentials([
                            ...
                            sh """
                                ...
                                git clone https://\${GITHUB_TOKEN}@github.com/mykola-ovchynnik/my-microservice-project.git infra-repo
                                cd infra-repo
